...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IntegrationStatusActions', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.IntegrationStatusActions;
      });

      it('should create an instance of IntegrationStatusActions', function() {
        // TODO: update the code to test IntegrationStatusActions
