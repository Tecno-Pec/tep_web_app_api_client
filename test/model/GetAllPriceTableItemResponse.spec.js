...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPriceTableItemResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPriceTableItemResponse();
      });

      it('should create an instance of GetAllPriceTableItemResponse', function() {
        // TODO: update the code to test GetAllPriceTableItemResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPriceTableItemResponse);
      });
