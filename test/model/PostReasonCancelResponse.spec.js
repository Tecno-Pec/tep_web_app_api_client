...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostReasonCancelResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostReasonCancelResponse();
      });

      it('should create an instance of PostReasonCancelResponse', function() {
        // TODO: update the code to test PostReasonCancelResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostReasonCancelResponse);
      });
