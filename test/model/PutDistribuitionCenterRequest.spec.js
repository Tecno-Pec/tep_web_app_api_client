...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutDistribuitionCenterRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PutDistribuitionCenterRequest();
      });

      it('should create an instance of PutDistribuitionCenterRequest', function() {
        // TODO: update the code to test PutDistribuitionCenterRequest
        expect(instance).to.be.a(TepsalesserviceApi.PutDistribuitionCenterRequest);
      });
