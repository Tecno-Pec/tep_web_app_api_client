...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedCommissionResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedCommissionResponse();
      });

      it('should create an instance of GetAllPagedCommissionResponse', function() {
        // TODO: update the code to test GetAllPagedCommissionResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedCommissionResponse);
      });
