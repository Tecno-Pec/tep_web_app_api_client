...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReasonCancelStatus', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.ReasonCancelStatus;
      });

      it('should create an instance of ReasonCancelStatus', function() {
        // TODO: update the code to test ReasonCancelStatus
