...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedPriceTableUnloadingResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedPriceTableUnloadingResponse();
      });

      it('should create an instance of GetAllPagedPriceTableUnloadingResponse', function() {
        // TODO: update the code to test GetAllPagedPriceTableUnloadingResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedPriceTableUnloadingResponse);
      });
