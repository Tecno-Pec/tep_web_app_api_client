...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllCompanyResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllCompanyResponse();
      });

      it('should create an instance of GetAllCompanyResponse', function() {
        // TODO: update the code to test GetAllCompanyResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllCompanyResponse);
      });
