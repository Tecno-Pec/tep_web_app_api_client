...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostVehicleTypeResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostVehicleTypeResponse();
      });

      it('should create an instance of PostVehicleTypeResponse', function() {
        // TODO: update the code to test PostVehicleTypeResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostVehicleTypeResponse);
      });
