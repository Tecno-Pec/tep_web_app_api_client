...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostPriceTableItemResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostPriceTableItemResponse();
      });

      it('should create an instance of PostPriceTableItemResponse', function() {
        // TODO: update the code to test PostPriceTableItemResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostPriceTableItemResponse);
      });
