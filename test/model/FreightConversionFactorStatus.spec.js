...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FreightConversionFactorStatus', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.FreightConversionFactorStatus;
      });

      it('should create an instance of FreightConversionFactorStatus', function() {
        // TODO: update the code to test FreightConversionFactorStatus
