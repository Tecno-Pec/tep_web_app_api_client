...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedDistribuitionCenterClientAddressResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedDistribuitionCenterClientAddressResponse();
      });

      it('should create an instance of GetAllPagedDistribuitionCenterClientAddressResponse', function() {
        // TODO: update the code to test GetAllPagedDistribuitionCenterClientAddressResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedDistribuitionCenterClientAddressResponse);
      });
