...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedProductGroupResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedProductGroupResponse();
      });

      it('should create an instance of GetAllPagedProductGroupResponse', function() {
        // TODO: update the code to test GetAllPagedProductGroupResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedProductGroupResponse);
      });
