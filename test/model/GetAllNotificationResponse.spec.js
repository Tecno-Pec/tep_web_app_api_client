...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllNotificationResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllNotificationResponse();
      });

      it('should create an instance of GetAllNotificationResponse', function() {
        // TODO: update the code to test GetAllNotificationResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllNotificationResponse);
      });
