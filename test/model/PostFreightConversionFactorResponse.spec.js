...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostFreightConversionFactorResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostFreightConversionFactorResponse();
      });

      it('should create an instance of PostFreightConversionFactorResponse', function() {
        // TODO: update the code to test PostFreightConversionFactorResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostFreightConversionFactorResponse);
      });
