...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostCommissionResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostCommissionResponse();
      });

      it('should create an instance of PostCommissionResponse', function() {
        // TODO: update the code to test PostCommissionResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostCommissionResponse);
      });
