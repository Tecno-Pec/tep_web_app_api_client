...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostDistribuitionCenterClientAddressResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostDistribuitionCenterClientAddressResponse();
      });

      it('should create an instance of PostDistribuitionCenterClientAddressResponse', function() {
        // TODO: update the code to test PostDistribuitionCenterClientAddressResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostDistribuitionCenterClientAddressResponse);
      });
