...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPurchaseOrderResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPurchaseOrderResponse();
      });

      it('should create an instance of GetAllPurchaseOrderResponse', function() {
        // TODO: update the code to test GetAllPurchaseOrderResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPurchaseOrderResponse);
      });
      ...
      it('should have the property reasonCancel (base name: "reasonCancel")', function() {
        // TODO: update the code to test the property reasonCancel
        expect(instance).to.have.property('reasonCancel');
        // expect(instance.reasonCancel).to.be(expectedValueLiteral);
      });
