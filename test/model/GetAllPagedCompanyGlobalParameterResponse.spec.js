...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedCompanyGlobalParameterResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedCompanyGlobalParameterResponse();
      });

      it('should create an instance of GetAllPagedCompanyGlobalParameterResponse', function() {
        // TODO: update the code to test GetAllPagedCompanyGlobalParameterResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedCompanyGlobalParameterResponse);
      });
