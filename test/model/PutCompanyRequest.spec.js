...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutCompanyRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PutCompanyRequest();
      });

      it('should create an instance of PutCompanyRequest', function() {
        // TODO: update the code to test PutCompanyRequest
        expect(instance).to.be.a(TepsalesserviceApi.PutCompanyRequest);
      });
