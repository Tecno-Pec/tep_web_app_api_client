...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedUserResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedUserResponse();
      });

      it('should create an instance of GetAllPagedUserResponse', function() {
        // TODO: update the code to test GetAllPagedUserResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedUserResponse);
      });
