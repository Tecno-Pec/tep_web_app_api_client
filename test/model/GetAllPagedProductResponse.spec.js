...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedProductResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedProductResponse();
      });

      it('should create an instance of GetAllPagedProductResponse', function() {
        // TODO: update the code to test GetAllPagedProductResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedProductResponse);
      });
