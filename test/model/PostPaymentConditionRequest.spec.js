...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostPaymentConditionRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostPaymentConditionRequest();
      });

      it('should create an instance of PostPaymentConditionRequest', function() {
        // TODO: update the code to test PostPaymentConditionRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostPaymentConditionRequest);
      });
