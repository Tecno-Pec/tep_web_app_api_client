...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllAddressResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllAddressResponse();
      });

      it('should create an instance of GetAllAddressResponse', function() {
        // TODO: update the code to test GetAllAddressResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllAddressResponse);
      });
