...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllIntegrationStatusResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllIntegrationStatusResponse();
      });

      it('should create an instance of GetAllIntegrationStatusResponse', function() {
        // TODO: update the code to test GetAllIntegrationStatusResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllIntegrationStatusResponse);
      });
      ...
      it('should have the property quantityEntities (base name: "quantityEntities")', function() {
        // TODO: update the code to test the property quantityEntities
        expect(instance).to.have.property('quantityEntities');
        // expect(instance.quantityEntities).to.be(expectedValueLiteral);
      });
