...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedPriceTableResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedPriceTableResponse();
      });

      it('should create an instance of GetAllPagedPriceTableResponse', function() {
        // TODO: update the code to test GetAllPagedPriceTableResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedPriceTableResponse);
      });
