...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DiscountWeightTypeEnum', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.DiscountWeightTypeEnum;
      });

      it('should create an instance of DiscountWeightTypeEnum', function() {
        // TODO: update the code to test DiscountWeightTypeEnum
