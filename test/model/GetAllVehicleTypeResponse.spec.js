...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllVehicleTypeResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllVehicleTypeResponse();
      });

      it('should create an instance of GetAllVehicleTypeResponse', function() {
        // TODO: update the code to test GetAllVehicleTypeResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllVehicleTypeResponse);
      });
