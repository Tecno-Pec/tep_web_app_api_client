...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllProductLineResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllProductLineResponse();
      });

      it('should create an instance of GetAllProductLineResponse', function() {
        // TODO: update the code to test GetAllProductLineResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllProductLineResponse);
      });
