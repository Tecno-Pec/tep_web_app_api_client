...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostClientRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostClientRequest();
      });

      it('should create an instance of PostClientRequest', function() {
        // TODO: update the code to test PostClientRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostClientRequest);
      });
