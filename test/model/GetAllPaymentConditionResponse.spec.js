...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPaymentConditionResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPaymentConditionResponse();
      });

      it('should create an instance of GetAllPaymentConditionResponse', function() {
        // TODO: update the code to test GetAllPaymentConditionResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPaymentConditionResponse);
      });
