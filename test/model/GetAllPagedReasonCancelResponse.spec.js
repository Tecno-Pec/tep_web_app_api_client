...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedReasonCancelResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedReasonCancelResponse();
      });

      it('should create an instance of GetAllPagedReasonCancelResponse', function() {
        // TODO: update the code to test GetAllPagedReasonCancelResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedReasonCancelResponse);
      });
