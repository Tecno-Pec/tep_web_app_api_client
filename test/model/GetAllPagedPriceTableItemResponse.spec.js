...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedPriceTableItemResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedPriceTableItemResponse();
      });

      it('should create an instance of GetAllPagedPriceTableItemResponse', function() {
        // TODO: update the code to test GetAllPagedPriceTableItemResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedPriceTableItemResponse);
      });
