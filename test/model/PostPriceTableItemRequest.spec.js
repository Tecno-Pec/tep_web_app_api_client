...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostPriceTableItemRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostPriceTableItemRequest();
      });

      it('should create an instance of PostPriceTableItemRequest', function() {
        // TODO: update the code to test PostPriceTableItemRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostPriceTableItemRequest);
      });
