...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PaymentConditionStatus', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.PaymentConditionStatus;
      });

      it('should create an instance of PaymentConditionStatus', function() {
        // TODO: update the code to test PaymentConditionStatus
