...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedDiscountWeightResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedDiscountWeightResponse();
      });

      it('should create an instance of GetAllPagedDiscountWeightResponse', function() {
        // TODO: update the code to test GetAllPagedDiscountWeightResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedDiscountWeightResponse);
      });
