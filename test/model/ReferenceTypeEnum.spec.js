...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReferenceTypeEnum', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.ReferenceTypeEnum;
      });

      it('should create an instance of ReferenceTypeEnum', function() {
        // TODO: update the code to test ReferenceTypeEnum
