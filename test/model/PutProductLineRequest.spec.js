...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutProductLineRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PutProductLineRequest();
      });

      it('should create an instance of PutProductLineRequest', function() {
        // TODO: update the code to test PutProductLineRequest
        expect(instance).to.be.a(TepsalesserviceApi.PutProductLineRequest);
      });
