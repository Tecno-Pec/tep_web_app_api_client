...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllFreightConversionFactorResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllFreightConversionFactorResponse();
      });

      it('should create an instance of GetAllFreightConversionFactorResponse', function() {
        // TODO: update the code to test GetAllFreightConversionFactorResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllFreightConversionFactorResponse);
      });
