...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedNotificationResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedNotificationResponse();
      });

      it('should create an instance of GetAllPagedNotificationResponse', function() {
        // TODO: update the code to test GetAllPagedNotificationResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedNotificationResponse);
      });
