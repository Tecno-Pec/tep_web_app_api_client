...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutCompanyGlobalParameterRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PutCompanyGlobalParameterRequest();
      });

      it('should create an instance of PutCompanyGlobalParameterRequest', function() {
        // TODO: update the code to test PutCompanyGlobalParameterRequest
        expect(instance).to.be.a(TepsalesserviceApi.PutCompanyGlobalParameterRequest);
      });
