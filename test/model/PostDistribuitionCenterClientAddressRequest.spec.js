...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostDistribuitionCenterClientAddressRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostDistribuitionCenterClientAddressRequest();
      });

      it('should create an instance of PostDistribuitionCenterClientAddressRequest', function() {
        // TODO: update the code to test PostDistribuitionCenterClientAddressRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostDistribuitionCenterClientAddressRequest);
      });
