...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductGroupStatus', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.ProductGroupStatus;
      });

      it('should create an instance of ProductGroupStatus', function() {
        // TODO: update the code to test ProductGroupStatus
