...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPriceTableResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPriceTableResponse();
      });

      it('should create an instance of GetAllPriceTableResponse', function() {
        // TODO: update the code to test GetAllPriceTableResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPriceTableResponse);
      });
