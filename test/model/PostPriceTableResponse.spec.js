...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostPriceTableResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostPriceTableResponse();
      });

      it('should create an instance of PostPriceTableResponse', function() {
        // TODO: update the code to test PostPriceTableResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostPriceTableResponse);
      });
