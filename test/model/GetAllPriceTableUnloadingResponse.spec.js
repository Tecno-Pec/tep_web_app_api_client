...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPriceTableUnloadingResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPriceTableUnloadingResponse();
      });

      it('should create an instance of GetAllPriceTableUnloadingResponse', function() {
        // TODO: update the code to test GetAllPriceTableUnloadingResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPriceTableUnloadingResponse);
      });
