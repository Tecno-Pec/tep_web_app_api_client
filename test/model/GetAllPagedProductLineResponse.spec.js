...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedProductLineResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedProductLineResponse();
      });

      it('should create an instance of GetAllPagedProductLineResponse', function() {
        // TODO: update the code to test GetAllPagedProductLineResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedProductLineResponse);
      });
