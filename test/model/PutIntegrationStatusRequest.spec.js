...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutIntegrationStatusRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PutIntegrationStatusRequest();
      });

      it('should create an instance of PutIntegrationStatusRequest', function() {
        // TODO: update the code to test PutIntegrationStatusRequest
        expect(instance).to.be.a(TepsalesserviceApi.PutIntegrationStatusRequest);
      });
