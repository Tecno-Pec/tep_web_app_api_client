...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostFreightTableResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostFreightTableResponse();
      });

      it('should create an instance of PostFreightTableResponse', function() {
        // TODO: update the code to test PostFreightTableResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostFreightTableResponse);
      });
