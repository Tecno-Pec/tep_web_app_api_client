...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedPaymentConditionResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedPaymentConditionResponse();
      });

      it('should create an instance of GetAllPagedPaymentConditionResponse', function() {
        // TODO: update the code to test GetAllPagedPaymentConditionResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedPaymentConditionResponse);
      });
