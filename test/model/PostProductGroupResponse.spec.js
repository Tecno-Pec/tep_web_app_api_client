...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostProductGroupResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostProductGroupResponse();
      });

      it('should create an instance of PostProductGroupResponse', function() {
        // TODO: update the code to test PostProductGroupResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostProductGroupResponse);
      });
