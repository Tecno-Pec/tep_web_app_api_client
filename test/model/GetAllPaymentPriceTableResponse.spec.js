...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPaymentPriceTableResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPaymentPriceTableResponse();
      });

      it('should create an instance of GetAllPaymentPriceTableResponse', function() {
        // TODO: update the code to test GetAllPaymentPriceTableResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPaymentPriceTableResponse);
      });
