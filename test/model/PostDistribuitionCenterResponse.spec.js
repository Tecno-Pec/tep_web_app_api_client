...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostDistribuitionCenterResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostDistribuitionCenterResponse();
      });

      it('should create an instance of PostDistribuitionCenterResponse', function() {
        // TODO: update the code to test PostDistribuitionCenterResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostDistribuitionCenterResponse);
      });
