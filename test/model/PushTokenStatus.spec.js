...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PushTokenStatus', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.PushTokenStatus;
      });

      it('should create an instance of PushTokenStatus', function() {
        // TODO: update the code to test PushTokenStatus
