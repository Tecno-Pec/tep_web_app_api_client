...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostDistribuitionCenterRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostDistribuitionCenterRequest();
      });

      it('should create an instance of PostDistribuitionCenterRequest', function() {
        // TODO: update the code to test PostDistribuitionCenterRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostDistribuitionCenterRequest);
      });
