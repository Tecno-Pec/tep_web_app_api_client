...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostTemplateResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostTemplateResponse();
      });

      it('should create an instance of PostTemplateResponse', function() {
        // TODO: update the code to test PostTemplateResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostTemplateResponse);
      });
