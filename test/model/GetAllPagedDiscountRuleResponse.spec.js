...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedDiscountRuleResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedDiscountRuleResponse();
      });

      it('should create an instance of GetAllPagedDiscountRuleResponse', function() {
        // TODO: update the code to test GetAllPagedDiscountRuleResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedDiscountRuleResponse);
      });
