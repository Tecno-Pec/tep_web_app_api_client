...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostCommissionRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostCommissionRequest();
      });

      it('should create an instance of PostCommissionRequest', function() {
        // TODO: update the code to test PostCommissionRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostCommissionRequest);
      });
