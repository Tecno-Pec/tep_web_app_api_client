...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostPaymentPriceTableRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostPaymentPriceTableRequest();
      });

      it('should create an instance of PostPaymentPriceTableRequest', function() {
        // TODO: update the code to test PostPaymentPriceTableRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostPaymentPriceTableRequest);
      });
