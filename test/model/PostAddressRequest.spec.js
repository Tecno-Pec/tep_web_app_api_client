...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostAddressRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostAddressRequest();
      });

      it('should create an instance of PostAddressRequest', function() {
        // TODO: update the code to test PostAddressRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostAddressRequest);
      });
