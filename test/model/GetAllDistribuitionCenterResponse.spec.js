...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllDistribuitionCenterResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllDistribuitionCenterResponse();
      });

      it('should create an instance of GetAllDistribuitionCenterResponse', function() {
        // TODO: update the code to test GetAllDistribuitionCenterResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllDistribuitionCenterResponse);
      });
