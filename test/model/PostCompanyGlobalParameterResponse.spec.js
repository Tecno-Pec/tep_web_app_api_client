...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostCompanyGlobalParameterResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostCompanyGlobalParameterResponse();
      });

      it('should create an instance of PostCompanyGlobalParameterResponse', function() {
        // TODO: update the code to test PostCompanyGlobalParameterResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostCompanyGlobalParameterResponse);
      });
