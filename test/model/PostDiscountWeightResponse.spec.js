...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostDiscountWeightResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostDiscountWeightResponse();
      });

      it('should create an instance of PostDiscountWeightResponse', function() {
        // TODO: update the code to test PostDiscountWeightResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostDiscountWeightResponse);
      });
