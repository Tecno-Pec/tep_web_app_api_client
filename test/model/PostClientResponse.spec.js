...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostClientResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostClientResponse();
      });

      it('should create an instance of PostClientResponse', function() {
        // TODO: update the code to test PostClientResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostClientResponse);
      });
