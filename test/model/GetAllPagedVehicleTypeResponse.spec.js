...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedVehicleTypeResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedVehicleTypeResponse();
      });

      it('should create an instance of GetAllPagedVehicleTypeResponse', function() {
        // TODO: update the code to test GetAllPagedVehicleTypeResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedVehicleTypeResponse);
      });
