...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllCommissionResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllCommissionResponse();
      });

      it('should create an instance of GetAllCommissionResponse', function() {
        // TODO: update the code to test GetAllCommissionResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllCommissionResponse);
      });
