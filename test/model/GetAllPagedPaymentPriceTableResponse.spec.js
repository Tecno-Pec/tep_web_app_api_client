...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedPaymentPriceTableResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedPaymentPriceTableResponse();
      });

      it('should create an instance of GetAllPagedPaymentPriceTableResponse', function() {
        // TODO: update the code to test GetAllPagedPaymentPriceTableResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedPaymentPriceTableResponse);
      });
