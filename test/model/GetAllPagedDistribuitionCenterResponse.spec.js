...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedDistribuitionCenterResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedDistribuitionCenterResponse();
      });

      it('should create an instance of GetAllPagedDistribuitionCenterResponse', function() {
        // TODO: update the code to test GetAllPagedDistribuitionCenterResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedDistribuitionCenterResponse);
      });
