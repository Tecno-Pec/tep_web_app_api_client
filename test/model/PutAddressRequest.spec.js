...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutAddressRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PutAddressRequest();
      });

      it('should create an instance of PutAddressRequest', function() {
        // TODO: update the code to test PutAddressRequest
        expect(instance).to.be.a(TepsalesserviceApi.PutAddressRequest);
      });
