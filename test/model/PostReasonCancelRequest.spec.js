...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostReasonCancelRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostReasonCancelRequest();
      });

      it('should create an instance of PostReasonCancelRequest', function() {
        // TODO: update the code to test PostReasonCancelRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostReasonCancelRequest);
      });
