...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutPriceTableRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PutPriceTableRequest();
      });

      it('should create an instance of PutPriceTableRequest', function() {
        // TODO: update the code to test PutPriceTableRequest
        expect(instance).to.be.a(TepsalesserviceApi.PutPriceTableRequest);
      });
