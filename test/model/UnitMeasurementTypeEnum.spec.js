...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UnitMeasurementTypeEnum', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.UnitMeasurementTypeEnum;
      });

      it('should create an instance of UnitMeasurementTypeEnum', function() {
        // TODO: update the code to test UnitMeasurementTypeEnum
