...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostPriceTableUnloadingRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostPriceTableUnloadingRequest();
      });

      it('should create an instance of PostPriceTableUnloadingRequest', function() {
        // TODO: update the code to test PostPriceTableUnloadingRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostPriceTableUnloadingRequest);
      });
