...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllDiscountRuleResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllDiscountRuleResponse();
      });

      it('should create an instance of GetAllDiscountRuleResponse', function() {
        // TODO: update the code to test GetAllDiscountRuleResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllDiscountRuleResponse);
      });
