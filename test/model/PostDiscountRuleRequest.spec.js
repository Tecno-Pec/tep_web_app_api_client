...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostDiscountRuleRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostDiscountRuleRequest();
      });

      it('should create an instance of PostDiscountRuleRequest', function() {
        // TODO: update the code to test PostDiscountRuleRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostDiscountRuleRequest);
      });
