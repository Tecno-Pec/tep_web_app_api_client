...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutCommissionRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PutCommissionRequest();
      });

      it('should create an instance of PutCommissionRequest', function() {
        // TODO: update the code to test PutCommissionRequest
        expect(instance).to.be.a(TepsalesserviceApi.PutCommissionRequest);
      });
