...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostIntegrationStatusRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostIntegrationStatusRequest();
      });

      it('should create an instance of PostIntegrationStatusRequest', function() {
        // TODO: update the code to test PostIntegrationStatusRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostIntegrationStatusRequest);
      });
