...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PriceTableStatus', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.PriceTableStatus;
      });

      it('should create an instance of PriceTableStatus', function() {
        // TODO: update the code to test PriceTableStatus
