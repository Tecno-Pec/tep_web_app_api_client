...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllTemplateResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllTemplateResponse();
      });

      it('should create an instance of GetAllTemplateResponse', function() {
        // TODO: update the code to test GetAllTemplateResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllTemplateResponse);
      });
