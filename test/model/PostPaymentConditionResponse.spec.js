...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostPaymentConditionResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostPaymentConditionResponse();
      });

      it('should create an instance of PostPaymentConditionResponse', function() {
        // TODO: update the code to test PostPaymentConditionResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostPaymentConditionResponse);
      });
