...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutPriceTableUnloadingRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PutPriceTableUnloadingRequest();
      });

      it('should create an instance of PutPriceTableUnloadingRequest', function() {
        // TODO: update the code to test PutPriceTableUnloadingRequest
        expect(instance).to.be.a(TepsalesserviceApi.PutPriceTableUnloadingRequest);
      });
