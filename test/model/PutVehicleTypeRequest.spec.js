...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutVehicleTypeRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PutVehicleTypeRequest();
      });

      it('should create an instance of PutVehicleTypeRequest', function() {
        // TODO: update the code to test PutVehicleTypeRequest
        expect(instance).to.be.a(TepsalesserviceApi.PutVehicleTypeRequest);
      });
