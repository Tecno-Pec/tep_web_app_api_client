...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostProductLineResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostProductLineResponse();
      });

      it('should create an instance of PostProductLineResponse', function() {
        // TODO: update the code to test PostProductLineResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostProductLineResponse);
      });
