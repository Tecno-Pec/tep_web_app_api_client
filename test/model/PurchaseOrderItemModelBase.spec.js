...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PurchaseOrderItemModelBase', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PurchaseOrderItemModelBase();
      });

      it('should create an instance of PurchaseOrderItemModelBase', function() {
        // TODO: update the code to test PurchaseOrderItemModelBase
        expect(instance).to.be.a(TepsalesserviceApi.PurchaseOrderItemModelBase);
      });
