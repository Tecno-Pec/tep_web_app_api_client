...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutDiscountWeightRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PutDiscountWeightRequest();
      });

      it('should create an instance of PutDiscountWeightRequest', function() {
        // TODO: update the code to test PutDiscountWeightRequest
        expect(instance).to.be.a(TepsalesserviceApi.PutDiscountWeightRequest);
      });
