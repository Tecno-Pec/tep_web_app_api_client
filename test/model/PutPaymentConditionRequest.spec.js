...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutPaymentConditionRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PutPaymentConditionRequest();
      });

      it('should create an instance of PutPaymentConditionRequest', function() {
        // TODO: update the code to test PutPaymentConditionRequest
        expect(instance).to.be.a(TepsalesserviceApi.PutPaymentConditionRequest);
      });
