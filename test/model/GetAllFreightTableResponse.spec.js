...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllFreightTableResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllFreightTableResponse();
      });

      it('should create an instance of GetAllFreightTableResponse', function() {
        // TODO: update the code to test GetAllFreightTableResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllFreightTableResponse);
      });
