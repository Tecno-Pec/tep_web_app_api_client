...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DiscountRuleStatus', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.DiscountRuleStatus;
      });

      it('should create an instance of DiscountRuleStatus', function() {
        // TODO: update the code to test DiscountRuleStatus
