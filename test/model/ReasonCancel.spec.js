...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReasonCancel', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.ReasonCancel();
      });

      it('should create an instance of ReasonCancel', function() {
        // TODO: update the code to test ReasonCancel
        expect(instance).to.be.a(TepsalesserviceApi.ReasonCancel);
      });
