...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostCompanyGlobalParameterRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostCompanyGlobalParameterRequest();
      });

      it('should create an instance of PostCompanyGlobalParameterRequest', function() {
        // TODO: update the code to test PostCompanyGlobalParameterRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostCompanyGlobalParameterRequest);
      });
