...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostNotificationRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostNotificationRequest();
      });

      it('should create an instance of PostNotificationRequest', function() {
        // TODO: update the code to test PostNotificationRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostNotificationRequest);
      });
