...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedClientResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedClientResponse();
      });

      it('should create an instance of GetAllPagedClientResponse', function() {
        // TODO: update the code to test GetAllPagedClientResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedClientResponse);
      });
