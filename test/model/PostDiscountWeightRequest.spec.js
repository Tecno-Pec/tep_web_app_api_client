...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostDiscountWeightRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostDiscountWeightRequest();
      });

      it('should create an instance of PostDiscountWeightRequest', function() {
        // TODO: update the code to test PostDiscountWeightRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostDiscountWeightRequest);
      });
