...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllReasonCancelResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllReasonCancelResponse();
      });

      it('should create an instance of GetAllReasonCancelResponse', function() {
        // TODO: update the code to test GetAllReasonCancelResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllReasonCancelResponse);
      });
