...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostTemplateRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostTemplateRequest();
      });

      it('should create an instance of PostTemplateRequest', function() {
        // TODO: update the code to test PostTemplateRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostTemplateRequest);
      });
