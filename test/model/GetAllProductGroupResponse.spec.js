...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllProductGroupResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllProductGroupResponse();
      });

      it('should create an instance of GetAllProductGroupResponse', function() {
        // TODO: update the code to test GetAllProductGroupResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllProductGroupResponse);
      });
