...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutReasonCancelRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PutReasonCancelRequest();
      });

      it('should create an instance of PutReasonCancelRequest', function() {
        // TODO: update the code to test PutReasonCancelRequest
        expect(instance).to.be.a(TepsalesserviceApi.PutReasonCancelRequest);
      });
