...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FreightType', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.FreightType;
      });

      it('should create an instance of FreightType', function() {
        // TODO: update the code to test FreightType
