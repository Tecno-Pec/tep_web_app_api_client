...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostPriceTableRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostPriceTableRequest();
      });

      it('should create an instance of PostPriceTableRequest', function() {
        // TODO: update the code to test PostPriceTableRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostPriceTableRequest);
      });
