...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedAuditResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedAuditResponse();
      });

      it('should create an instance of GetAllPagedAuditResponse', function() {
        // TODO: update the code to test GetAllPagedAuditResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedAuditResponse);
      });
