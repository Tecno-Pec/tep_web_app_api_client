...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductLineStatus', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.ProductLineStatus;
      });

      it('should create an instance of ProductLineStatus', function() {
        // TODO: update the code to test ProductLineStatus
