...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedIntegrationStatusResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedIntegrationStatusResponse();
      });

      it('should create an instance of GetAllPagedIntegrationStatusResponse', function() {
        // TODO: update the code to test GetAllPagedIntegrationStatusResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedIntegrationStatusResponse);
      });
