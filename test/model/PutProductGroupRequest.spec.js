...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutProductGroupRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PutProductGroupRequest();
      });

      it('should create an instance of PutProductGroupRequest', function() {
        // TODO: update the code to test PutProductGroupRequest
        expect(instance).to.be.a(TepsalesserviceApi.PutProductGroupRequest);
      });
