...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PriceTableItemStatus', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.PriceTableItemStatus;
      });

      it('should create an instance of PriceTableItemStatus', function() {
        // TODO: update the code to test PriceTableItemStatus
