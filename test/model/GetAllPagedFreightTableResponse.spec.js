...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedFreightTableResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedFreightTableResponse();
      });

      it('should create an instance of GetAllPagedFreightTableResponse', function() {
        // TODO: update the code to test GetAllPagedFreightTableResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedFreightTableResponse);
      });
