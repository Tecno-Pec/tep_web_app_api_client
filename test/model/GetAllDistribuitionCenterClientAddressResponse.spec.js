...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllDistribuitionCenterClientAddressResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllDistribuitionCenterClientAddressResponse();
      });

      it('should create an instance of GetAllDistribuitionCenterClientAddressResponse', function() {
        // TODO: update the code to test GetAllDistribuitionCenterClientAddressResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllDistribuitionCenterClientAddressResponse);
      });
