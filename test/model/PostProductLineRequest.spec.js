...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostProductLineRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostProductLineRequest();
      });

      it('should create an instance of PostProductLineRequest', function() {
        // TODO: update the code to test PostProductLineRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostProductLineRequest);
      });
