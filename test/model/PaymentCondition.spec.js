...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PaymentCondition', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PaymentCondition();
      });

      it('should create an instance of PaymentCondition', function() {
        // TODO: update the code to test PaymentCondition
        expect(instance).to.be.a(TepsalesserviceApi.PaymentCondition);
      });
