...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostUserRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostUserRequest();
      });

      it('should create an instance of PostUserRequest', function() {
        // TODO: update the code to test PostUserRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostUserRequest);
      });
