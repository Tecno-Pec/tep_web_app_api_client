...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedCompanyResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedCompanyResponse();
      });

      it('should create an instance of GetAllPagedCompanyResponse', function() {
        // TODO: update the code to test GetAllPagedCompanyResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedCompanyResponse);
      });
