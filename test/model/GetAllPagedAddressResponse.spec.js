...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedAddressResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedAddressResponse();
      });

      it('should create an instance of GetAllPagedAddressResponse', function() {
        // TODO: update the code to test GetAllPagedAddressResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedAddressResponse);
      });
