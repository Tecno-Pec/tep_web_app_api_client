...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PutFreightConversionFactorRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PutFreightConversionFactorRequest();
      });

      it('should create an instance of PutFreightConversionFactorRequest', function() {
        // TODO: update the code to test PutFreightConversionFactorRequest
        expect(instance).to.be.a(TepsalesserviceApi.PutFreightConversionFactorRequest);
      });
