...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllClientResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllClientResponse();
      });

      it('should create an instance of GetAllClientResponse', function() {
        // TODO: update the code to test GetAllClientResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllClientResponse);
      });
