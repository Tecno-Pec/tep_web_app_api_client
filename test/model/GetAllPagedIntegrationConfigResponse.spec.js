...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedIntegrationConfigResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedIntegrationConfigResponse();
      });

      it('should create an instance of GetAllPagedIntegrationConfigResponse', function() {
        // TODO: update the code to test GetAllPagedIntegrationConfigResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedIntegrationConfigResponse);
      });
