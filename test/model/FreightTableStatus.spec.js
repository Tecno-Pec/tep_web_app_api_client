...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FreightTableStatus', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.FreightTableStatus;
      });

      it('should create an instance of FreightTableStatus', function() {
        // TODO: update the code to test FreightTableStatus
