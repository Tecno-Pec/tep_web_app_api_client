...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('User', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.User();
      });

      it('should create an instance of User', function() {
        // TODO: update the code to test User
        expect(instance).to.be.a(TepsalesserviceApi.User);
      });
      ...
      it('should have the property forceChangePassword (base name: "forceChangePassword")', function() {
        // TODO: update the code to test the property forceChangePassword
        expect(instance).to.have.property('forceChangePassword');
        // expect(instance.forceChangePassword).to.be(expectedValueLiteral);
      });

      it('should have the property pushTokens (base name: "pushTokens")', function() {
        // TODO: update the code to test the property pushTokens
        expect(instance).to.have.property('pushTokens');
        // expect(instance.pushTokens).to.be(expectedValueLiteral);
      });
