...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostIntegrationStatusResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostIntegrationStatusResponse();
      });

      it('should create an instance of PostIntegrationStatusResponse', function() {
        // TODO: update the code to test PostIntegrationStatusResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostIntegrationStatusResponse);
      });
