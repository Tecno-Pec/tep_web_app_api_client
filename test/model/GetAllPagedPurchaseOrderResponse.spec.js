...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedPurchaseOrderResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedPurchaseOrderResponse();
      });

      it('should create an instance of GetAllPagedPurchaseOrderResponse', function() {
        // TODO: update the code to test GetAllPagedPurchaseOrderResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedPurchaseOrderResponse);
      });
