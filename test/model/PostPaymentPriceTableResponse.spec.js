...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostPaymentPriceTableResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostPaymentPriceTableResponse();
      });

      it('should create an instance of PostPaymentPriceTableResponse', function() {
        // TODO: update the code to test PostPaymentPriceTableResponse
        expect(instance).to.be.a(TepsalesserviceApi.PostPaymentPriceTableResponse);
      });
