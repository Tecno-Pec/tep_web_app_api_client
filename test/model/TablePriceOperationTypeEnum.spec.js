...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TablePriceOperationTypeEnum', function() {
      beforeEach(function() {
        instance = TepsalesserviceApi.TablePriceOperationTypeEnum;
      });

      it('should create an instance of TablePriceOperationTypeEnum', function() {
        // TODO: update the code to test TablePriceOperationTypeEnum
