...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAllPagedTemplateResponse', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.GetAllPagedTemplateResponse();
      });

      it('should create an instance of GetAllPagedTemplateResponse', function() {
        // TODO: update the code to test GetAllPagedTemplateResponse
        expect(instance).to.be.a(TepsalesserviceApi.GetAllPagedTemplateResponse);
      });
