...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostFreightTableRequest', function() {
      beforeEach(function() {
        instance = new TepsalesserviceApi.PostFreightTableRequest();
      });

      it('should create an instance of PostFreightTableRequest', function() {
        // TODO: update the code to test PostFreightTableRequest
        expect(instance).to.be.a(TepsalesserviceApi.PostFreightTableRequest);
      });
